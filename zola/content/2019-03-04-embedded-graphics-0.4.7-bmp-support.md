...
There are some other fields present in the header segments, but they're not important for bitmap
parsing.
...
The `Header` struct is all we need to parse from the BMP file to be able to use it. On 32 bit
